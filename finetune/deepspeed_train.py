...
def build_content(instruction: str):
    return '''
{}
...
def preprocess(
    ...
    examples_tokenized = [_tokenize_fn([strings], tokenizer) for strings in (sources)]
...
def train():
    ...
    # )
    raw_train_datasets = load_from_disk(dataset_path=data_args.data_path)
