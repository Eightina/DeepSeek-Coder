...
EOT_TOKEN = "<|EOT|>"
checkpoint = "/root/autodl-tmp/dev/DeepSeek-Coder/finetune/checkpoints/checkpoint-300"
...
def get_args():
    ...
    # parser.add_argument("--model_path", type=str, default="/root/autodl-tmp/dev/DeepSeek-Coder/finetune/checkpoints/checkpoint-300")
